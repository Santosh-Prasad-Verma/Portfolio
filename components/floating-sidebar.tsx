      ...
      <AnimatePresence>
        {(isOpen || !isMobile) && (
          <motion.div
            ...
            className={`fixed  ${isMobile ? "inset-0 bg-black/80 z-40" : "top-1/3 right-6 transform -translate-y-1/2 z-30"
              }`}
          >
            <motion.nav
              className={`flex ${isMobile ? "h-full w-64 flex-col justify-center items-center" : "flex-col items-center"
