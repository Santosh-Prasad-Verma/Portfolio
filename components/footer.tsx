    ...
    <footer id="footer" className="w-full bg-black py-20 border-t border-zinc-800/30">
      <div className="container mx-auto px-6">
        ...
        >
          <div>
            <div className="flex items-baseline mb-4">
              <h3 className="text-xl font-bold text-white">Santosh Verma</h3>
              <span className="text-blue-400 ml-1 text-xl">—</span>
            </div>
            <p className="text-zinc-400 text-sm max-w-xs mb-6">
              Aspiring Data Engineer building scalable solutions.
            </p>
            <div className="flex items-center space-x-5">
              <Link
                href="https://github.com/Santosh-Prasad-Verma"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/in/santosh-prasad-verma-6a59b4240/"
                target="_blank"
                className="text-zinc-500 hover:text-blue-400 transition-all duration-300 transform hover:-translate-y-1"
                aria-label="LinkedIn"
              >
              ...
              <Link
                href="mailto:clayjen74@gmail.com"
          ...
          <div className="md:flex md:justify-end">
            <div>
              ...
              <a
                href="/Santosh_Prasad_Verma.pdf"
                download="Santosh_Verma_Resume.pdf"
        ...
        <div className="mt-20 pt-6 border-t border-zinc-800/30 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-zinc-500 text-xs">© {new Date().getFullYear()} Santosh Verma. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
